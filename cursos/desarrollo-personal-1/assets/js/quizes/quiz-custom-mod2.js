...
$(function(){
    ...
    var correctCount = 0;
    var q = [
        {'Q':'Auto conocerse es...', 'A':2,'C':['aprender cosas nuevas','conocer lo que siempre has sido y seras','conocer cosas nuevas sobre uno mismo']},
        {'Q':'¿Cual es el primer nivel de la pirámide de Maslow?', 'A':3,'C':['seguridad','sociales','Fisiológicas']},
        {'Q':'Auto conocerse es...', 'A':2,'C':['aprender cosas nuevas sobre la vida','conocer lo que siempre has sido y seras','conocer cosas nuevas sobre uno mismo']}
    ];
