...
$(function(){
    ...
    var correctCount = 0;
    var q = [
        {'Q':'¿Qué es reconciliar?', 'A':2,'C':['Un acto mecánico','Recomponer algo dañado','Descomponer algo dañado']},
        {'Q':'¿Qué es la introspección?', 'A':3,'C':['Analizar tu exterior','Analizar a quienes te rodean','Analizar tu yo interno']},
        {'Q':'¿Qué es reconciliar?', 'A':2,'C':['Un acto mecánico','Recomponer algo dañado','Descomponer algo dañado']}
    ];
